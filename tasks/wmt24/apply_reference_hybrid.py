...
df["metric_name"] = "metametrics-mt-mqm-hybrid"
df['SEGMENT-SCORE'] = 0
...
submission_df["metric_name"] = "metametrics-mt-mqm-hybrid"
...
os.system("mkdir -p submission/metametrics_mt_mqm_hybrid_kendall")
...
submission_df.to_csv('submission/metametrics_mt_mqm_hybrid_kendall/metametrics_mt_mqm_hybrid_kendall.score', sep="\t", index=False) 