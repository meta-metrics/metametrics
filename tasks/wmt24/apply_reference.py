...
df["metric_name"] = "metametrics-mt-mqm"
df['SEGMENT-SCORE'] = 0
...
submission_df["metric_name"] = "metametrics-mt-mqm"
...
os.system("mkdir -p submission/metametrics_mt_mqm_kendall")
...
submission_df.to_csv('submission/metametrics_mt_mqm_kendall/metametrics_mt_mqm_kendall.seg.score', sep="\t", index=False) 