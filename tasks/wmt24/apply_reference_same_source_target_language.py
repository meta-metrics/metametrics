...
submission_df["metric_name"] = "metametrics-mt-mqm-lang"
...
os.system("mkdir -p submission/metametrics_mt_mqm_same_source_target_kendall")
...
submission_df.to_csv('submission/metametrics_mt_mqm_same_source_target_kendall/metametrics_mt_mqm_same_source_target_kendall.seg.score', sep="\t", index=False)