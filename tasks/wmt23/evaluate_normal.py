...
metric = MetaMetrics(metrics_configs, weights=[0.47564685309663024,0.5798178227787706], normalize=True, cache_mode=False)

# metricx-23-qe-xxl-v2p0_reference_free0.47564685309663024
# wmt22-cometkiwi-da_reference_free0.5798178227787706
