...
metric_name = 'metametrics-lite'
metric = MetaMetrics(metrics_configs, weights=[1,0.7182397187204927], normalize=True, cache_mode=True)

# metricx-23-large-v2p01
# wmt22-comet-da0.7182397187204927
